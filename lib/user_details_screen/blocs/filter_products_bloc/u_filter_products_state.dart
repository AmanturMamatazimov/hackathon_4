...
abstract class UserFilterProductsState extends Equatable {
  const UserFilterProductsState();

  @override
  List<Object?> get props => [];
}

class UserFilterProductsInitial extends UserFilterProductsState {}

class UserFilterProductsLoadingState extends UserFilterProductsState {}

class UserFilterProductsLoadedState extends UserFilterProductsState {
  ...
  const UserFilterProductsLoadedState({
  ...
  UserFilterProductsLoadedState copyWith({
    ...
    return UserFilterProductsLoadedState(
  ...
  // factory UserFilterProductsLoadedState.fromMap(Map<String, dynamic> map) {
  //   return UserFilterProductsLoadedState(
...
class UserFilterProductsFailureState extends UserFilterProductsState {
  final String errorText;
  const UserFilterProductsFailureState({required this.errorText});
  @override
