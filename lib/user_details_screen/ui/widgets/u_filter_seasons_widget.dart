        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              h12,
              BlocBuilder<UserFilterProductsBloc, UserFilterProductsState>(
                      ...
                      children: [
                        CCheckBoxTile(
                          onChanged: (_) => context
                              ...
                              .add(UserFilterProductsSeasonChangeEvent(id: 3)),
                          label: 'Деми',
                        ...
                        CCheckBoxTile(
                          onChanged: (_) => context
                              .read<UserFilterProductsBloc>()
                              .add(UserFilterProductsSeasonChangeEvent(id: 1)),
                          label: 'Зима',
                        ...
                        CCheckBoxTile(
                          onChanged: (_) => context
                              .read<UserFilterProductsBloc>()
                              .add(UserFilterProductsSeasonChangeEvent(id: 2)),
                          label: 'Лето',
